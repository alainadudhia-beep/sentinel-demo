...
const INTEL_WARNINGS: IntelWarning[] = [
  {
    ...
    message:
      "Management interviews often overrun into Week 2. Based on Ashcombe engagement history, we recommend keeping at least one Junior Associate available through end of Week 2 to support interview synthesis and data processing. Reducing junior capacity at Week 1 creates a real bottleneck risk going into the interim findings push.",
  },
  {
...
const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Proven team composition for Ashcombe engagements",
    ],
    note: "Matches team structure from 9 of 12 previous Ashcombe CDDs",
  },
  {
    id: "premium",
    label: "Premium",
