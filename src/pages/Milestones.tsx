      ...
      <div className="max-w-7xl mx-auto px-6 py-10 space-y-8">
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between flex-wrap gap-3">
            <p className="text-sm font-semibold text-foreground flex items-center gap-2">
              ...
              Daily check-in · 15 min · Brookline + James Whitfield (Ashcombe Capital Partners)
            </p>
        ...
        <Dialog open={showDraft} onOpenChange={setShowDraft}>
          <DialogContent className="max-w-lg">
            <DialogHeader>
              <DialogTitle className="text-base">Draft early warning — James Whitfield (Ashcombe)</DialogTitle>
            </DialogHeader>
