...
const MILESTONE_INTERNAL_HEX = "#f97316"; // orange  — Brookline Owned
...
function milestoneLabel(ownership?: "client" | "internal" | "target") {
  if (ownership === "internal") return "Milestone — Brookline Owned";
...
export const INITIAL_GANTT_SECTIONS: GanttInputSection[] = [
  ...
  },
  {
    ...
    milestones: [
      { id: "m-mg-1", label: "Ashcombe confirms interview plan", week: 0, day: 3, ownership: "client", subRowIdx: 0 },
      { id: "m-mg-2", label: "Interviews complete",          week: 1, day: 4, ownership: "target", subRowIdx: 2 },
    ],
    subRows: [
      { id: "mg-r1", rowLabel: "Plan to Ashcombe", spans: [{ id: "mg-s1", label: "Plan to Ashcombe", startWeek: 0, startDay: 1, endWeek: 0, endDay: 3 }] },
    ...
    <div ref={containerRef} className="overflow-x-auto border border-border rounded-xl bg-card shadow-sm select-none"
      ...
      <div style={{ width: LABEL_W + 20 * COL_W }}>
        ...
        <div className="flex items-center gap-4 px-3 py-1.5 border-b border-border/20 bg-muted/5">
          {([["client", MILESTONE_CLIENT_HEX, "Client Owned"], ["internal", MILESTONE_INTERNAL_HEX, "Brookline Owned"], ["target", MILESTONE_TARGET_HEX, "Target Owned"]] as const).map(([, hex, lbl]) => (
    ...
    <div className="max-w-5xl xl:max-w-[1700px] mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <div className="bg-card border border-border rounded-lg overflow-hidden">
          <div className="flex items-center justify-between px-4 py-2.5 border-b border-border bg-muted/20">
            <p className="text-xs font-semibold text-foreground">Ashcombe — client history</p>
      ...
      {showClientIntelModal && (
        <HistoryModal
          ...
          sections={[{ heading: "All Ashcombe engagements", engagements: CLIENT_HISTORY, showClient: false }]}
