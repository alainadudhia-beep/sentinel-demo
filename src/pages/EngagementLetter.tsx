...
const CLIENT          = "Ashcombe Capital Partners";
const CLIENT_EMAIL    = "james.whitfield@ashcombe.example";
const TARGET          = "FreshCart";
const FIRM            = "Brookline Strategy";
const REFERENCE       = "EL-2026-0421-ASH";
