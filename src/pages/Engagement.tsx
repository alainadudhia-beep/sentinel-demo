...
const PAST_ENGAGEMENTS = [
  // ── Ashcombe ──
  { client: "Ashcombe", project: "Consumer Retail CDD",        target: "Online grocery delivery",       weeks: 3, overrun: 1.5, fee: 285000, satisfaction: 3.9, team: "3P · 1M · 2C · 3A", additions: ["Supplier concentration risk (W2)", "Online vs offline channel split (W3)"],         keyLearning: "Add supplier concentration and channel mix upfront. Data room access clause needed." },
  { client: "Ashcombe", project: "B2B SaaS CDD",               target: "Industrial SaaS",               weeks: 3, overrun: 0,   fee: 195000, satisfaction: 4.4, team: "2P · 1M · 1C · 2A", additions: ["Integration partner concentration (W1)", "CAC payback with PS allocation (W2)"], keyLearning: "SaaS deals: add integration dependency and true CAC to standard scope template." },
  { client: "Ashcombe", project: "Healthcare Tech CDD",         target: "Digital health platform",       weeks: 3, overrun: 0,   fee: 218000, satisfaction: 4.5, team: "2P · 1M · 2C · 2A", additions: ["Reimbursement risk analysis (W2)"],                                                  keyLearning: "Digital health requires regulatory reimbursement scoping from Day 1." },
  { client: "Ashcombe", project: "Consumer Fintech CDD",        target: "BNPL platform",                 weeks: 4, overrun: 1,   fee: 310000, satisfaction: 4.0, team: "3P · 1M · 2C · 3A", additions: ["Fraud loss rate benchmarking (W1)", "Regulatory capital requirements (W2)"],       keyLearning: "BNPL: add fraud benchmarking and regulatory capital to standard fintech scope." },
  { client: "Ashcombe", project: "Last-Mile Logistics CDD",     target: "On-demand delivery network",    weeks: 2, overrun: 0,   fee: 162000, satisfaction: 4.3, team: "2P · 1M · 1C · 2A", additions: ["Driver classification risk (W1)"],                                                   keyLearning: "Gig logistics: worker classification risk always surfaces — scope it upfront." },
  { client: "Ashcombe", project: "EdTech Growth Equity CDD",    target: "Corporate L&D platform",        weeks: 3, overrun: 0.5, fee: 225000, satisfaction: 4.1, team: "2P · 1M · 1C · 2A", additions: ["Sales cycle and CAC benchmarking (W2)"],                                            keyLearning: "B2B EdTech: enterprise sales cycle length consistently underestimated by management." },
  { client: "Ashcombe", project: "Home Services CDD",           target: "Home services marketplace",     weeks: 3, overrun: 0,   fee: 198000, satisfaction: 4.6, team: "2P · 1M · 1C · 2A", additions: ["Supply-side retention analysis (W2)"],                                               keyLearning: "Marketplace: supply-side retention as critical as demand-side — always add both." },
  { client: "Ashcombe", project: "Enterprise Software CDD",     target: "ERP platform for SMEs",         weeks: 4, overrun: 0,   fee: 275000, satisfaction: 4.4, team: "2P · 1M · 2C · 3A", additions: ["Implementation partner dependency (W1)"],                                            keyLearning: "ERP: partner channel concentration risk consistently underweighted. Add to template." },
  { client: "Ashcombe", project: "Food & Beverage CDD",         target: "Restaurant delivery aggregator", weeks: 3, overrun: 1, fee: 260000, satisfaction: 3.8, team: "2P · 1M · 2C · 2A", additions: ["Restaurant churn by geography (W2)", "Dark kitchen economics (W3)"],                 keyLearning: "Food delivery: dark kitchen economics and geographic churn diverge significantly." },
  { client: "Ashcombe", project: "Proptech CDD",                target: "Residential lettings platform",  weeks: 2, overrun: 0, fee: 145000, satisfaction: 4.5, team: "1P · 1M · 1C · 2A", additions: [],                                                                                      keyLearning: "Clean engagement — well-scoped upfront with no mid-project additions." },
  { client: "Ashcombe", project: "Cybersecurity Growth CDD",    target: "SME security SaaS",              weeks: 3, overrun: 0, fee: 205000, satisfaction: 4.3, team: "2P · 1M · 1C · 2A", additions: ["Incident response capability benchmarking (W2)"],                                     keyLearning: "Cyber: IR benchmarking always added — build into standard SaaS security scope." },
  { client: "Ashcombe", project: "Consumer Subscription CDD",   target: "Beauty box subscription",        weeks: 2, overrun: 0.5, fee: 172000, satisfaction: 4.0, team: "2P · 1M · 1C · 2A", additions: ["Cohort churn depth by acquisition channel (W1)"],                                 keyLearning: "Subscription: acquisition channel mix drives churn divergence — scope cohort depth upfront." },
  // ── Comparable consumer retail CDDs (other clients) ──
  { client: "Oakmere",project: "Consumer Retail CDD",  target: "Omnichannel retail",             weeks: 3, overrun: 1,   fee: 350000, satisfaction: 3.7, team: "2P · 1M · 1C · 3A", additions: ["Greater N expert interviews", "Consumer survey edits (multiple rounds)"],              keyLearning: "Client over-extends survey scope. Clear timeline dependency clauses or 20% scope buffer." },
  { client: "Calder", project: "Consumer Retail CDD",  target: "Fashion e-commerce platform",    weeks: 3, overrun: 0,   fee: 295000, satisfaction: 4.2, team: "2P · 1M · 2C · 2A", additions: ["Returns economics analysis (W2)"],                                                      keyLearning: "Fashion e-com: returns rate and unit economics on returned goods always underscoped." },
  { client: "Stirling",project: "Consumer Retail CDD",  target: "Health & wellness marketplace",  weeks: 3, overrun: 0,   fee: 268000, satisfaction: 4.4, team: "2P · 1M · 1C · 2A", additions: [],                                                                                         keyLearning: "Well-scoped engagement — clear scope letter with named dependencies delivered on time." },
  { client: "Fenwick", project: "Consumer Retail CDD", target: "Direct-to-consumer supplements", weeks: 4, overrun: 0.5, fee: 335000, satisfaction: 4.0, team: "3P · 1M · 2C · 3A", additions: ["Influencer channel concentration risk (W2)", "Regulatory claims risk (W3)"],            keyLearning: "DTC: influencer concentration and regulatory claims risk on supplements — scope both upfront." },
];

// Current deal context
const CURRENT_CLIENT = "Ashcombe";
          ...
          <div key={i} className="px-5 py-4 space-y-2.5">
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="text-right shrink-0">
                ...
                {e.overrun > 0 && (
                  <p className="text-[10px] text-red-600 mt-0.5">Overrun absorbed by Brookline</p>
                )}
              </div>
            </div>
...
export default function Engagement() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-10 space-y-10">
      ...
      {showClientModal && (
        <HistoryModal
          title="Ashcombe Capital Partners — client history"
