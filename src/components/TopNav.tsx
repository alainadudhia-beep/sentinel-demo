...
import { FileText, CheckCircle2, ListChecks, AlertTriangle, MessageSquare, Eye, Presentation } from "lucide-react";
...
const stepOrder = ["/scope", "/scope-review", "/live-scope", "/plan", "/slide-review", "/project"];
