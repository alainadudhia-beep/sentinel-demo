...
export const RISK_FLAGS: RiskFlag[] = [
  {
    ...
    historical: "3 of 5 recent Ashcombe deals",
    detail:
    ...
    recommendation:
      "Require confirmed data room access as a condition of the engagement letter. If access is not in place by Day 1, project will likely need an extension. Make this a named Week 0 deliverable with a named Ashcombe contact responsible.",
    clause: "Data room access — condition precedent to project start",
  },
  {
    id: "rf2",
    severity: "amber",
    title: "Unscoped additions — Ashcombe pattern of mid-project changes",
    historical: "Occurred on 4 of last 4 Ashcombe engagements",
    detail:
      "Ashcombe consistently adds 1–2 questions via email mid-project. On previous engagements this resulted in unscoped work absorbed by Brookline with no fee adjustment. With a 3-week timeline there is no slack to absorb additions without impacting delivery.",
    recommendation:
  ...
  },
  {
    ...
    recommendation:
      "Agree to regularly update the client outside of formal meetings to prevent misaligned expectations. If scope materially changes after Interim presentation, Brookline is not liable for delays to IC materials or project extensions to cover additional questions.",
...
const INITIAL_INPUT_PIPELINE: InputPipelineRow[] = [
  ...
  },
  {
    ...
    phases: [
      { id: "mg-1", label: "Schedule to Ashcombe",  week: 0, day: 1 }, // W0 Tue — ramp
