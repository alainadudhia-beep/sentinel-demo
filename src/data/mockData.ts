...
Daniel: Makes sense. What about the management team?
...
Daniel: And timeline — when do you need this?
...
Daniel: Absolutely. What about the financial model — do you want us to build our own or work from theirs?

James: Build your own. We don't trust theirs.

Daniel: Fine. We'll need data room access from day one of the full project — can you confirm that's in place? We've had delays on similar deals that compressed the timeline significantly.

James: Should be. I'll chase the target today.

Daniel: Great. We'll come back to you with a draft scope by end of tomorrow. To confirm, the key questions are market size, share and drivers; competitive positioning and trends; customer retention and perception of FreshCart; financial model and growth plan assessment. Does that sound right?

James: Yep that's all I can think of for now. Thanks.

Daniel: Great, I'll get started on ramp up with the manager to get going on prepping the data request, drafting a survey and setting up interviews. Let's speak tomorrow re scope. Thanks James.`;

export const sampleEngagementLetter = `ENGAGEMENT LETTER — CONFIDENTIAL

Project: Commercial Due Diligence — Project Falcon
Client: Ashcombe Capital Partners
Target: FreshCart Ltd (UK online grocery delivery)
Date: 14 March 2025
Prepared by: Brookline Strategy

1. OBJECTIVE
Brookline Strategy ("Brookline") has been engaged by Ashcombe Capital Partners ("the Client") to conduct a commercial due diligence assessment of FreshCart Ltd ("the Target"), a UK-based online grocery delivery platform. The objective is to evaluate market positioning, competitive dynamics, customer retention economics, and growth sustainability to support the Client's investment decision.
...
6. ASSUMPTIONS
  ...
  • All deliverables subject to Brookline quality review process`;
